...
const jobTitleContainer1 = document.querySelector(".jobContainer1");
const jobTitleContainer2 = document.querySelector(".jobContainer2");
...
window.addEventListener("scroll", () => {
  ...
  imgContainer.style.transform = `translate(${offsetY * 0.4}px, ${
    offsetY * 0.7
  }px)`;
  authorName.style.transform = `translateX(${offsetY * 0.2}px)`;
  jobTitleContainer1.style.backgroundPositionY = `${offsetY * 0.5}px`;
  jobTitleContainer2.style.backgroundPositionY = `${-offsetY * 0.5}px`;
